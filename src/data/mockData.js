...
export const routes = [
  {
    id: 1, origin: 'Madrid', destination: 'Barcelona',
    originCoords: [40.4168, -3.7038], destinationCoords: [41.3851, 2.1734],
    driver: 5, truck: 1, cargo: 1, status: 'in-progress',
    distance: 621, estimatedTime: '6h 30min', duration: 6.5,
    departure: '2026-06-11 08:00', arrival: '2026-06-11 14:30', progress: 65,
  },
  {
    id: 2, origin: 'Sevilla', destination: 'Madrid',
    originCoords: [37.3891, -5.9845], destinationCoords: [40.4168, -3.7038],
    driver: 2, truck: 3, cargo: 3, status: 'in-progress',
    distance: 534, estimatedTime: '5h 45min', duration: 5.75,
    departure: '2026-06-11 09:00', arrival: '2026-06-11 14:45', progress: 40,
  },
  {
    id: 3, origin: 'Valencia', destination: 'Bilbao',
    originCoords: [39.4699, -0.3763], destinationCoords: [43.2627, -2.9253],
    driver: null, truck: null, cargo: 2, status: 'pending',
    distance: 615, estimatedTime: '6h 15min', duration: 6.25,
    departure: '2026-06-12 07:00', arrival: '2026-06-12 13:15', progress: 0,
  },
  {
    id: 4, origin: 'Madrid', destination: 'Sevilla',
    originCoords: [40.4168, -3.7038], destinationCoords: [37.3891, -5.9845],
    driver: null, truck: null, cargo: 5, status: 'pending',
    distance: 534, estimatedTime: '5h 30min', duration: 5.5,
    departure: '2026-06-13 08:00', arrival: '2026-06-13 13:30', progress: 0,
  },
  {
    id: 5, origin: 'Barcelona', destination: 'Valencia',
    originCoords: [41.3851, 2.1734], destinationCoords: [39.4699, -0.3763],
    driver: null, truck: null, cargo: 4, status: 'completed',
    distance: 349, estimatedTime: '3h 30min', duration: 3.5,
    departure: '2026-06-10 09:00', arrival: '2026-06-10 12:30', progress: 100,
  },
]

export const metrics = {
  totalDrivers: 8, availableDrivers: 4,
  totalTrucks: 6, availableTrucks: 3,
  activeRoutes: 2, pendingRoutes: 2,
